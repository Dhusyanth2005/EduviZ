export const microchipData = {
    ...
    parts: {
        ...
        gateOxide: {
            modelId: "67f42245b32752b6cc130972", // Example model ID (replace with actual ID)
            name: "Gate Oxide",
        ...
        polysiliconGate: {
            modelId: "67f42263b32752b6cc13097e", // Example model ID (replace with actual ID)
        ...
        metalLayers: {
            modelId: "67f42298b32752b6cc1309c5", // Example model ID (replace with actual ID)
        ...
        bondingPads: {
            modelId: "67f4216fb32752b6cc130967", // Example model ID (replace with actual ID)
            name: "Bonding Pads",
